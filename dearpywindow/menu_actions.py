...
def update_point_menu():
    ...
    [
        figure.disable_selection()
        for figure in point.PointCounterMeta.points_list.values()
    ]
...
def dump_json_callback(sender, app_data):
    ...
    if abs_path is not None:
        ...
        create_points.DumpPointToJson(
            point.PointCounterMeta.points_list.values(), abs_path
        )
